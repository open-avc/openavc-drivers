...
class _FakeBaseDriver:
    """Functional stand-in for the BaseDriver surface this driver uses,
    including the child-entity registry (mirrors base.py semantics: writes to
    an unregistered child are skipped, state keys are namespaced)."""
...
class _FakeTCPTransport:
    ...
    async def create(cls, *, host, port, on_data, on_disconnect,
                     frame_parser=None, delimiter=None, timeout=5.0, name=""):
