...
class _FakeBaseDriver:
    ...
    unregistered children are skipped, state keys are namespaced, a
    per-child schema is only allowed for dynamic child types)."""
...
def test_metadata_and_platform_gate():
    ...
    # Dynamic string/integer-id children from device-enumerated rosters.
